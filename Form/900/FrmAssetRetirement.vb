Public Class FrmAssetRetirement
    ...
    Private Sub NpiButton1_Click(sender As Object, e As EventArgs) Handles NpiButton1.Click
        ...
        Header1.Add("             BSEC-NAME1                         บจ. พี.ที.ซัพพลาย แอนด์ โลจิสติกส์")
        Header1.Add("             BSEC-STRAS                         29/4 ถ.ชากกลาง-มิตรประชา ต.ห้วยโป่ง")
        Header1.Add("             BSEC-ORT01                         อ.เมืองระยอง จ.ระยอง")
        Header1.Add("             BSEC-PSTLZ                         21150")
        Header1.Add("             BSEC-LAND1                         TH")
        Header1.Add("             BSEC-STCD1                         0215556003473")
        Header1.Add("             BSEC-STCD2                         00000")
        Header1.Add("             BDC_OKCODE                         /00")
        Header1.Add("SAPMF05A0301X")
        Header1.Add("             BSEG-WRBTR                         " & DT.Compute("sum(Price)*1.07", "").ToString())
        Header1.Add("             BKPF-XMWST                         X")
        Header1.Add("             BSEG-MWSKZ                         o7")
        Header1.Add("             BSEG-ZTERM                         nt00")
        Header1.Add("             BSEG-ZBD1T                         60")
        Header1.Add("             BSEG-SGTXT                         ตัดขาย Asset ชำรุด")
