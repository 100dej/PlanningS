CREATE proc Table_MasterPlanning_Sql (@Scase int,@xcase int,@mat nvarchar(18),@NEng nvarchar(40),@VUname nvarchar(20),@Vname nvarchar(30),@mproduct nvarchar(30),@mtype nvarchar(30))
as
