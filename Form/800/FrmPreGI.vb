        ...
        If Date1 = Nothing Then
            ...
            If cdl.ShowDialog = Windows.Forms.DialogResult.OK Then
                Try
                    ...
                    If dtgItem.Columns.Count - 1 < 2 Then
                    ...
                    For r As Integer = 0 To dtgItem.Rows.Count - 1
                        Try
                            cmd = cx.CommandCreate("insert into tbt_600preGiToConsoh (HeaderText,itemNo,Productcode,OrderQty) values (?,?,?,?)", "TITI")
